...
namespace delay_lama_assets {
    constinit const auto control_panel_png = png_view(control_panel_png_data);
    constinit const auto help_panel_png = png_view(help_panel_png_data);
    constinit const auto monk_sprite_sheet_png = png_view(monk_sprite_sheet_png_data);
    constinit const auto knob_strip_a_png = png_view(knob_strip_a_png_data);
    constinit const auto knob_strip_b_png = png_view(knob_strip_b_png_data);
    constinit const auto scene_background_png = png_view(scene_background_png_data);
    constinit const auto ui_tile_a_png = png_view(ui_tile_a_png_data);
    constinit const auto ui_tile_b_png = png_view(ui_tile_b_png_data);
    constinit const auto ui_arrow_png = png_view(ui_arrow_png_data);
